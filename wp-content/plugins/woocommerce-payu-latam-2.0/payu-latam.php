		...
		function init_form_fields() {
			$this->form_fields = array(
                ...
                'response_page' => array(
					...
					'default' => __('http://su.dominio.com/wp-content/plugins/woocommerce-payu-latam-2.0/response.php', 'payu_latam')),
                'confirmation_page' => array(
					...
					'default' => __('http://su.dominio.com/wp-content/plugins/woocommerce-payu-latam-2.0/confirmation.php', 'payu_latam'))
			);
		}
