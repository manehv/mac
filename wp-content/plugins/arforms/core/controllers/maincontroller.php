...
class maincontroller {
    ...
    function arfforms_check_network_activation( $network_wide )
    {
         if ( ! $network_wide )
            return;
    ...
    function wp_ar_autoupdate() {
        ...
        if ($verified == 1) {
            $wp_ar_plugin_current_version = '2.7.3';
    ...
    function get_form_shortcode_popup($atts) {
        ...
        $bgcolor = isset($atts['bgcolor']) ? $atts['bgcolor'] : '';
        $txtcolor = isset($atts['txtcolor']) ? $atts['txtcolor'] : '';

        if ($shortcode_type == 'normal') {
            return $arrecordcontroller->show_form($id, $key, $title, $description);
        }

        return $arrecordcontroller->show_form_popup($id, $key, $title, $description, $desc, $type, $modal_height, $modal_width, $position, $btn_angle, $bgcolor, $txtcolor);
    }
    ...
    function upgrade_data() {
        ...
        if (version_compare($newdbversion, '2.7.3', '<')) {
