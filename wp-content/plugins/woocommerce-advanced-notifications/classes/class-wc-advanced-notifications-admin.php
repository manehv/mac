...
class WC_Advanced_Notifications_Admin {
	...
	function write_panel() {
		...
		<p class="form-field">
			...
			<select id="notification_recipients" name="notification_recipients[]" multiple="multiple" style="width:300px;" data-placeholder="<?php _e('Choose recipients for this product&hellip;', 'wc_table_rate'); ?>" class="wc-enhanced-select chosen_select">
				<?php
