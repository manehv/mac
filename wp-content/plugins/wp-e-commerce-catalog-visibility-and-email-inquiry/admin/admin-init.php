...
class WPEC_Email_Inquiry_Admin_Init extends WPEC_Email_Inquiry_Admin_UI
{
	...
	public function admin_settings_page( $page_data = array() ) {
        ...
        <div class="wrap">
			...
			<?php 
					if ( $page_data !== false) {
						echo esc_html( $page_data['menu_title'] ); 
...
$wpec_ei_admin_init = new WPEC_Email_Inquiry_Admin_Init();
