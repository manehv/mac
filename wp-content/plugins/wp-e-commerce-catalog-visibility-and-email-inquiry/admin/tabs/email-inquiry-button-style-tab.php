...
class WPEC_EI_Button_Style_Tab extends WPEC_Email_Inquiry_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wpec_ei_button_style_tab_manager',
		);
...
global $wpec_ei_button_style_tab;
$wpec_ei_button_style_tab = new WPEC_EI_Button_Style_Tab();

/** 
 * wpec_ei_button_style_tab_manager()
 * Define the callback function to show tab content
 */
function wpec_ei_button_style_tab_manager() {
	global $wpec_ei_button_style_tab;
	$wpec_ei_button_style_tab->tab_manager();
}
