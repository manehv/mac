...
start_chat:"Iniciar Chat",offline_body:"Sorry! We're not around right now. Leave a message using the form below and we'll get back to you, asap.",reply_ph:"Type here and hit enter to chat",send_btn:"Send",no_op:"No hay operadores en este momento",no_msg:"No messages found",sending:"Enviando",connecting:"Conectando",writing:"%s esta escribiendo",please_wait:"Please wait",chat_online:"Chat Online",chat_offline:"Chat Offline",optional:"Optional",your_msg:"Your message",end_chat:"Terminar Chat",conn_err:"error conectando!",you:"Tu",
online_btn:"Online",offline_btn:"Offline",field_empty:"Llena los campos requeridos",invalid_email:"E-mail incorrecto",op_not_allowed:"Operators do not chat from here, only visitors. If you want to test chat box, you will want to use two different browsers or computers",months:"January February March April May June July August September October November December".split(" "),months_short:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),time:{suffix:"ago",seconds:"less than a minute",
