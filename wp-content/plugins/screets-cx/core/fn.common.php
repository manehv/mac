...
function cx_get_jquery_plug_opts() {
	...
	return apply_filters( 'cx_plugin_opts', array(
			...
			'msg'					=> array(
				...
				'sending' => cx_sanitize( __( 'Enviando', 'cx' ) ),
				'connecting' => cx_sanitize( __( 'Conectando', 'cx' ) ),
				'writing' => cx_sanitize( __( '%s is writing', 'cx' ) ),
				'please_wait' => cx_sanitize( __( 'Espera por favor', 'cx' ) ),
				...
				'conn_err' => cx_sanitize( __( 'Error de conexión!', 'cx' ) ),
				'field_empty' => cx_sanitize( __( 'Por favor digite todos los campos', 'cx' ) ),
				'invalid_email' => cx_sanitize( __( 'E-mail no válido', 'cx' ) ),
