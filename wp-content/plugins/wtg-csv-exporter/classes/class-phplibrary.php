...
//class WTGCSVEXPORTER_PHP extends WTGCSVEXPORTER_Flags { commented 14092014
class WTGCSVEXPORTER_PHP {  
    /**
    ...
    * @package WTG CSV Exporter
    * @since 0.0.1
    * @version 1.0.3 - Last Change: pattern improved 
    */
    ...
    */
    public function arrayinfo_set( $array, $line, $function, $file ){
        ...
        $array['arrayinfo']['date'] = WTGCSVEXPORTER::datewp();
        return $array;   
    }  
    ...
    * 2. Faster than wtgcsvexporter_count_extension_in_directory() because it returns sooner, important for directory with a lot of files
    * 
    * @returns boolean
    */
    ...
    */
    public function type( $value ){
        ...
        // is email address
        if( WTGCSVEXPORTER::is_valid_emailaddress( $value ) ){
            return 'email';
        }                  
    ...
    */
    public function months_time_range( $month, $year, $return = 'array', $format = 'time' ){
        ...
        if( $format == 'date' )
        {
            $array['start'] = WTGCSVEXPORTER::datewp(0, $array['start'] );
        }
        ...
        if( $format == 'date' )
        {    
            $array['end'] = WTGCSVEXPORTER::datewp(0, $array['end'] );   
        }
