...
* @version 1.0.4 
*/
//class WTGCSVEXPORTER_DB extends WTGCSVEXPORTER_UpdatePlugin { commented 14092014
class WTGCSVEXPORTER_DB {     
    /**
    ...
    */
    public function options_beginning_with( $prependvalue){    
        ...
        // loop through each option record and check their name value for wtgcsvexporter_ at the beginning
    ...
    */
    public function log_queryactions() {
        global $wpdb;    
        return $wpdb->get_results( 'SELECT DISTINCT action FROM '.$wpdb->prefix.'wtglog',ARRAY_A );    
    }
