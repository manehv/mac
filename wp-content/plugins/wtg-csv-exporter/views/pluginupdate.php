...
class CSV2POST_Pluginupdate_View extends CSV2POST_View {
    ...
    */
    ...
    public function setup( $action, array $data ) {
        ...
        if( isset( $wtgcsvexporter_settings['currentproject'] ) && $wtgcsvexporter_settings['currentproject'] !== false ) {
            $this->project_object = $this->CSV2POST->get_project( $wtgcsvexporter_settings['currentproject'] ); 
