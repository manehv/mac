 ...
 * @since 0.0.1
 */
class WTGCSVEXPORTER_Pages_View extends WTGCSVEXPORTER_View {
    ...
    */
    public function meta_box_array() {
        ...
        return $this->meta_boxes_array = array(
            ...
            array( $this->view_name . '-exportpagescolumns', __( 'Select Columns', 'wtgcsvexporter' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 'exportpagescolumns' ), true, 'activate_plugins' ),
    ...
    */
    public function datatables( $data, $box ) {       
        $WPTableObject = new WTGCSVEXPORTER_WPTable_Example();
    ...
    * @version 1.0
    */
    public function postbox_pages_exportpagescolumns( $data, $box ) { 
        global $wpdb, $wtgcsvexporter_settings;
        
        $current_settings_array = array();
        if( isset( $wtgcsvexporter_settings['csvexportprofiles']['pages']['tables']['posts'] ) ) { 
            $current_settings_array = $wtgcsvexporter_settings['csvexportprofiles']['pages']['tables']['posts'];
        }
...
*/
class WTGCSVEXPORTER_WPTable_Example extends WP_List_Table {
