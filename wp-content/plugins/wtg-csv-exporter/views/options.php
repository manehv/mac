<?php
/**
 * View for exporting all options.
 *
 ...
 * @since 0.0.1
 */
class WTGCSVEXPORTER_Options_View extends WTGCSVEXPORTER_View {
    ...
    */
    public function datatables( $data, $box ) {       
        $WPTableObject = new WTGCSVEXPORTER_Options_Example();
    ...
    * @version 1.0
    */
    public function postbox_Options_datasourcestable( $data, $box ) { 
        global $wpdb;
        ...
        <?php         
        $table_columns = $wpdb->get_col( "DESC " . $wpdb->prefix . 'options', 0 );
...
*/
class WTGCSVEXPORTER_Options_Example extends WP_List_Table {
