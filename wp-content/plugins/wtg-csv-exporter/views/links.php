 ...
 * @since 0.0.1
 */
class WTGCSVEXPORTER_Links_View extends WTGCSVEXPORTER_View {
    ...
    */
    public function datatables( $data, $box ) {       
        $WPTableObject = new WTGCSVEXPORTER_Links_Example();
    ...
    * @version 1.0
    */
    public function postbox_Links_datasourcestable( $data, $box ) { 
        global $wpdb;
        ...
        <?php         
        $table_columns = $wpdb->get_col( "DESC " . $wpdb->prefix . 'links', 0 );
...
*/
class WTGCSVEXPORTER_Links_Example extends WP_List_Table {
    ...
    function column_default( $item, $column_name ){   
        ...
        switch( $column_name){
            ...
            case 'link_description':
                return $item['link_description'];
                break;    
            //case 'link_visible':
            //    return $item['link_visible'];
            //    break;    
            //case 'link_owner':
            //    return $item['link_owner'];
            //    break;    
            //case 'link_rating':
            //    return $item['link_rating'];
            //    break;    
            //case 'link_updated':
            //    return $item['link_updated'];
            //    break;    
            //case 'link_rel':
            //    return $item['link_rel'];
            //    break;    
            //case 'link_notes':
            //    return $item['link_notes'];
            //    break;    
            //case 'link_rss':
            //    return $item['link_rss'];
            //    break;                       
