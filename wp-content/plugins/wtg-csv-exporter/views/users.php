 ...
 * @since 0.0.1
 */
class WTGCSVEXPORTER_Users_View extends WTGCSVEXPORTER_View {
    ...
    */
    public function datatables( $data, $box ) {       
        $WPTableObject = new WTGCSVEXPORTER_Users_Example();
    ...
    * @version 1.0
    */
    public function postbox_users_datasourcestable( $data, $box ) { 
        global $wpdb;
        ...
        <?php         
        $table_columns = $wpdb->get_col( "DESC " . $wpdb->prefix . 'users', 0 );
...
*/
class WTGCSVEXPORTER_Users_Example extends WP_List_Table {
    ...
    function column_default( $item, $column_name ){   
        ...
        switch( $column_name){
            ...
            //    return $item['user_activation_key'];
            //    break;    
            case 'user_status':
                return $item['user_status'];
                break;    
            case 'display_name':
