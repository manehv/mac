<?php
/**
 * View for exporting all "post" (not pages or custom post types)
 *
 ...
 * @since 0.0.1
 */
class WTGCSVEXPORTER_Posts_View extends WTGCSVEXPORTER_View {
    ...
    */
    public function meta_box_array() {
        ...
        return $this->meta_boxes_array = array(
            ...
            array( $this->view_name . '-exportpostscolumns', __( 'Select Columns', 'wtgcsvexporter' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 'exportpostscolumns' ), true, 'activate_plugins' ),
    ...
    * @version 1.0
    */
    public function postbox_posts_exportpostscolumns( $data, $box ) { 
        global $wpdb, $wtgcsvexporter_settings;
        
        $current_settings_array = array();
        if( isset( $wtgcsvexporter_settings['csvexportprofiles']['posts']['tables']['posts'] ) ) { 
            $current_settings_array = $wtgcsvexporter_settings['csvexportprofiles']['posts']['tables']['posts'];
        }
