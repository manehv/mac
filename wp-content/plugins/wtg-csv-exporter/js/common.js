/**
 * JavaScript code for all WTG CSV Exporter admin screens, it makes postboxes work
 *
 * @package WTG CSV Exporter
 * @subpackage Views JavaScript
 * @author Tobias Bäthge (author of WTGCSVEXPORTER plugin)
 * @since 0.0.1
 */
...
jQuery( document ).ready( function( $ ) {
	 ...
	 * For WTGCSVEXPORTER, pagenow has the form "tablepress_{$action}"
	 *
	 * @since 0.0.1
	 */
