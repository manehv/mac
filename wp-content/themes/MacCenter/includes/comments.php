...
<!--<div class='comment_meta_container alpha <?php avia_layout_class('meta'); ?> units'>-->
...
if ( have_comments() ) : ?>
                        ...
                        <!--<div class='comment_container <?php avia_layout_class('entry'); ?> units'>-->
...
<?php           
                if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through?
                        ...
                        $indent = ""; // avia_offset_class('meta', false);
                        ?>
