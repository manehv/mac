...
height: 50px;
margin: auto;
background-image: url('http://arbolnaranja.com/e-commerceMC/LOGO-MACCENTER.png');
...
background-image: url('http://arbolnaranja.com/e-commerceMC/actualizando-01.png');
background-repeat: no-repeat;
...
width: 100%;
height:700px;
background-image: url('http://arbolnaranja.com/e-commerceMC/TIENDAS-01.jpg');
