jQuery(document).ready(function($) {
	...
	$('form.variations_form')
		...
		.on( 'focusin', '.variations input:radio', function( event ) {
				...
				if(($(this).attr('name'))==($('.variations input:radio').attr('name')))
				{	
					$('.variations input:radio[name !="attribute_color"]').prop('disabled',false)
				                                                      .prop('checked',false);
				}																											
						...
						for(var k=0;k<custom_data_var.length;k++)
						{
							 ...
							 { 
							   $('#shipping').text(custom_data_var[k].shipping);
								 ...
								 $('.variations').find('input[type=radio][name='+lastname+'][value='+attval+']').next().text(custom_data_var[k].discription);
								 $('.variations').find('input[type=radio][name='+lastname+'][value='+attval+']').next().next().text($('#price').text());
								  ...
								  if(count>($('input[type=radio]:checked').length)-1)
									{
										...
										var erprice=custom_data_var[k].attributes['_price'];
										var erval=custom_data_var[k].attributes[lastname];
										var dis=custom_data_var[k].discription;
								    erval=erval[0].toUpperCase();
										
										$('.variations').find('input[type=radio][name='+lastname+'][value='+erval+']').next().text(dis);
								    $('.variations').find('input[type=radio][name='+lastname+'][value='+erval+']').next().next().text(erprice);
