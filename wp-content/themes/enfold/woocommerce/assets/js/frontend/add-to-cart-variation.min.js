						...
						for(var k=0;k<custom_data_var.length;k++)
						{
							 ...
							 { 
							   $('#shipping').text(custom_data_var[k].shipping);
								 ...
								 $('.variations').find('input[type=radio][name='+lastname+'][value='+attval+']').next().next().text(custom_data_var[k].discription);
								 $('.variations').find('input[type=radio][name='+lastname+'][value='+attval+']').next().text($('#price').text());
