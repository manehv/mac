jQuery(document).ready(function($) {
	...
	$('form.variations_form')
		...
		.on('click','#clear', function( event ) {
			...
			jQuery('.variations fieldset').not(':first').find('input[type=radio]').prop('disabled',false)
			                 .prop('checked',false);
		...
		/*	if($(this).attr('name')==$('.variations input:radio').attr('name'))	 
			{
				 $('.variations input:radio').not('name:'+$(this).attr('name')).prop('disabled',false)
				                             .prop('checked',false);
			}*/
		...
		.on( 'focusin', '.variations input:radio', function( event ) {
				...
				if(($(this).attr('name'))==($('.variations input:radio').attr('name')))
				{	
					var att_name=jQuery('.variations fieldset').find('input[type=radio]:first').attr('name');
					$('.variations input:radio[name !="'+att_name+'"]').prop('disabled',false)
				                                                      .prop('checked',false);
				}																											
    ...
    function find_matching_variations(product_variations,settings ) {
			...
			jQuery('.variations fieldset:last').find('input[type=radio]').parent().removeClass('radio-active');
	      	...
	      	var tempvar=0;
					...
					{	
					  ...
					  temp2=0;
							jQuery('.variations').find('input[type=radio]:first').each(function()
							{ 
			...
			if (variations_match(variation.attributes,settings)) {
		        ...
		        $('#prodtitle').text($('#prodtitle').attr('title')+" "+valtxt);
					  ...
					  $('del').remove();
						$('.info').text('');
						$('.modelprice').text('');
						var custom_data_var=$.parseJSON($('.variations_form').attr('custom_data'));
						for(var k=0;k<custom_data_var.length;k++)
						{
							 var lastname= $('.variations').find('input[type=radio]:last').attr('name');
							 if(variation.variation_id==custom_data_var[k].variation_id)
							 { 
							   $('#shipping').text(custom_data_var[k].shipping);
								 var attval=variation.attributes[lastname].toUpperCase();
								 $('.variations').find('input[type=radio][name='+lastname+'][value='+attval+']').parent().parent().find('.info').text(custom_data_var[k].discription);
								 $('.variations').find('input[type=radio][name='+lastname+'][value='+attval+']').parent().parent().find('.modelprice').text($('#price').text());
							 ...
							 else
							 {
								 ...
								 var count=0;
								  for (var key in variation.attributes) 
									{
										attrcont++;
									  if((custom_data_var[k].attributes[key]==variation.attributes[key]) && key!=lastname)
										{
											count++;
										}
								  }
								  if(count>($('input[type=radio]:checked').length)-1)
									{
										
										var erprice=custom_data_var[k].price;
										var erval=custom_data_var[k].attributes[lastname];
										var dis=custom_data_var[k].discription;
								    erval=erval[0].toUpperCase();
										
										$('.variations').find('input[type=radio][name='+lastname+'][value='+erval+']').parent().parent().find('.info').text(dis);
								    $('.variations').find('input[type=radio][name='+lastname+'][value='+erval+']').parent().parent().find('.modelprice').text(erprice);
        ...
        jQuery('.variations fieldset:last').find('input[type=radio]:checked').parent().addClass('radio-active');
