								 ...
								 var count=0;
								  ...
								  if(count>($('input[type=radio]:checked').length)-1)
								    ...
								    erval=erval[0].toUpperCase();
										...
										$('.variations').find('input[type=radio][name='+lastname+'][value='+erval+']').next().next().text(dis);
								    $('.variations').find('input[type=radio][name='+lastname+'][value='+erval+']').next().text(erprice);
