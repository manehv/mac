...
$key .header_bg, $key .main_menu ul ul, $key .main_menu .menu ul li a, $key .pointer_arrow_wrap .pointer_arrow, $key .avia_mega_div{
background-color:$bg;
color: $meta;
}
...
@media only screen and (max-width: 767px) { .av_header_transparency #advanced_menu_toggle{
	background-color:$bg;
	color: $color;
	border-color: $border;
}
