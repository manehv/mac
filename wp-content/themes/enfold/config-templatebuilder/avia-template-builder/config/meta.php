...
array(
	...
	array(
        ...
        "slug"	=> "layout",
        "name" 	=> __("Activate Header transparency",'avia_framework'),
        "desc" 	=> __("If checked the header will be transparent and once the user scrolls down it will fade in.",'avia_framework'),
